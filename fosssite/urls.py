...
urlpatterns = [
	...
	url(r'^(?P<name>[\w\-]+)/logout/$',views.logout,name='logout'),
	...
	url(r'^(?P<name>[\w\-]+)/events/$',views.events,name='events'),
	url(r'^(?P<name>[\w\-]+)/contributions/$',views.contributions,name='contributions'),
	url(r'^(?P<name>[\w\-]+)/blog/$',views.blog,name='blog'),
